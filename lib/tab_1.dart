...
import 'package:my_express2/jobdetail.dart';
import 'dart:convert';
...
import 'package:my_express2/SlideRightRoute.dart';
...
class _TabScreenState extends State<TabScreen> {
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              color: Colors.blue[300],
                              child: Center(
                                child: Text("PickUp Available Today",
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white)),
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs =
        "http://alifmirzaandriyanto.com/mydriver/php/load_jobs.php";
