...
import 'package:my_express2/payment.dart';
...
import 'package:my_express2/info_card.dart';
import 'package:url_launcher/url_launcher.dart' as launcher;

String urlgetuser = "http://alifmirzaandriyanto.com/mydriver/php/get_user.php";
String urluploadImage =
    "http://alifmirzaandriyanto.com/mydriver/php/upload_imageprofile.php";
String urlupdate =
    "http://alifmirzaandriyanto.com/mydriver/php/update_profile.php";
File _image;
int number = 0;
String _value;
                                      ...
                                      decoration: new BoxDecoration(
                                          ...
                                          image: new DecorationImage(
                                              ...
                                              image: new NetworkImage(
                                                  "http://alifmirzaandriyanto.com/mydriver/profile/${widget.user.email}.jpg?dummy=${(number)}'")))),
                                ),
                                SizedBox(height: 5),
                                Container(
                                  child: Text(
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (BuildContext context) => RegisterDriver()));
              },
            ),
            new FlatButton(
              child: new Text("No"),
