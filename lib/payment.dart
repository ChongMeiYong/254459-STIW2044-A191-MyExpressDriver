  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      body: Column(children: <Widget>[
        ...
        initialUrl: 'http://alifmirzaandriyanto.com/mydriver/php/payment.php?email='+widget.user.email+'&mobile='+widget.user.phone+'&name='+widget.user.name+'&amount='+widget.val+'&orderid='+widget.orderid,
